...
export const Speakers: ISpeaker = {
  ...
  meta: {
    paginator: {
      ...
      per_page: '15',
      current_page: 1,
      next_page: 'https://api.BookingAndCleaning.co.ke/v1/events/BookingAndCleaningke-2022-281/speakers?per_page=15&page=2',
      has_more_pages: true,
      next_page_url: 'https://api.BookingAndCleaning.co.ke/v1/events/BookingAndCleaningke-2022-281/speakers?per_page=15&page=2',
