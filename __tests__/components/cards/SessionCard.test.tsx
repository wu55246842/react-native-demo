...
const schedule = {
  ...
  is_keynote: false,
  is_bookmarked: true,
  start_date_time: '2022-10-16 08:30:00',
  start_time: '08:30:00',
  end_date_time: '2022-10-16 10:00:00',
  end_time: '10:00:00',
  speakers: [],
  rooms: [
    {
...
const session = {
  ...
  is_keynote: true,
  session_image:
    'https://res.cloudinary.com/BookingAndCleaning/image/upload/v1668083311/prod/upload/sessions/pwt9pnojtmng8bymxkls.png',
  speakers: [
    {
      name: 'Rich Bowen',
